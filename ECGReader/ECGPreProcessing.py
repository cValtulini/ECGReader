...
def plotXML(tracks,fullname,sim,destination_path):  
    ...
    fig, ax = plt.subplots(6, 2, figsize=(100/2.54, 50/2.54),sharex=False,squeeze=False,gridspec_kw=gs_kw)
    ...
    #These ranges for the amplitudes were found as the minimum and the maximum from the entire dataset
    range_min=-55
    range_max=42
